...
<html>
<head>
	<title>Madlibs: Calvin Kleijn</title>
	<meta charset="UTF-8">
...
<div id="main">
    ...
    <p>
      Er heerst paniek in het koninkrijk <?php echo $land ?>. Koning <?php echo $spijbel ?> is ten einde raad en als koning <?php echo $spijbel ?> tegen einde raad is, dan roept hij zijn ten-einde-raadsheer <?php echo $persoon ?>.<br><br>
